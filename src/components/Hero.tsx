...
const Hero: React.FC = () => {
  ...
  useEffect(() => {
    // Set symposium date (example: March 15, 2025)
    const symposiumDate = new Date('2025-03-15T09:00:00');
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center space-y-6 lg:space-y-0 lg:space-x-12">
              <div className="flex items-center">
                ...
                <div className="text-left">
                  ...
                  <p className="text-lg font-semibold text-slate-800">March 15, 2025</p>
                </div>
              </div>
              ...
              <div className="flex items-center">
                ...
                <div className="text-left">
                  ...
                  <p className="text-lg font-semibold text-slate-800">CSE Department</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="flex justify-center space-x-4">
              {Object.entries(timeLeft).map(([unit, value]) => (
                <div key={unit} className="bg-white rounded-lg shadow-sm border border-slate-200 p-4 min-w-[80px]">
                  <div className="text-2xl font-bold text-slate-800">{value}</div>
                  <div className="text-sm text-slate-500 capitalize">{unit}</div>
                </div>
              ))}
            </div>
          </div>
